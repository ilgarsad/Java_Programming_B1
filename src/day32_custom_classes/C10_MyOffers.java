...
public class C10_MyOffers {
    public static void main(String[] args) {
        C7_OfferV2 offer1 = new C7_OfferV2("Facebook", "California", 15000.00,true, 28);
        System.out.println(offer1);

        System.out.println("--------------------");
        C7_OfferV2 offer2 = new C7_OfferV2("Amazon", "Arlington", 145000.00);
        ...
        C7_OfferV2[] offerArr = {offer1, offer2};
        C7_OfferV2[] offerArr2 = { new C7_OfferV2("Tesla", "Texas"),
                new C7_OfferV2("Google", "California")};
