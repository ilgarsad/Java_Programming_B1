...
public class C7_GiftCard {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("After buying " + item1 + ", I have left " + giftCard + " dollars in gift card");

        giftCard -=100;

        System.out.println("After buying " + item2 + ", I have left " + giftCard + " dollars in gift card");
