...
public class C4_AddAndRemove {
    public static void main(String[] args) {
        ...
        String removed = list.remove(0);    // removes the first element and returns the removed element. Since data type of the removed element is String, we can assign it to a String variable.
        ...
        // It has a method that checks if there is an element before the next cycle starts
