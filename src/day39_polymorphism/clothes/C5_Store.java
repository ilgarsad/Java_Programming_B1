...
public class C5_Store {
    public static void main(String[] args) {
        ...
        C3_TShirt t1 = new C3_TShirt();
        t1.wear();


        // THe reference is ---> Super class
        C1_Clothes t2 = new C3_TShirt();
        t2.wear();
        ...
        // Reference is -- > ITSELF
        C4_Jacket j = new C4_Jacket();
        j.wear();
        j.putOnHood();


        // The reference is --- > SUPER CLASS
        C1_Clothes j2 = new C4_Jacket();
        j2.wear();
