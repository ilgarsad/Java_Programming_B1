...
public class C3_DebitCard {
    ...
    public C3_DebitCard(long cardNumber, String holderName, String cardType) {
    ...
    public C3_DebitCard(long cardNumber, String holderName, double balance, String cardType, int pin) {
