...
public class C1_Overtime {
    ...
    public static void main(String[] args) {
        ...
        if (workedHours > 40) {
            ...
            System.out.println("You have worked " + workedHours + " hours at the rate of " + hourlyRate + ", but with " + extraHours + " extra hours overtime. So you get in total pay of $" + netPay);

        } else {

            netPay = workedHours * hourlyRate;

            System.out.println("You have worked " + workedHours + " hours at the rate of " + hourlyRate + ", So you get in total pay of $" + netPay);
        }
